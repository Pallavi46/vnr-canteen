    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">VNR</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
var bestDishes = [
    {
        title: 'Fried Rice',
        rating: 5,
        imgURL: "https://i.ytimg.com/vi/PNpVCrIlnPg/maxresdefault.jpg",
    ...
    },
    {
        title: 'Noodles',
        rating: 4,
        imgURL: "https://www.indianhealthyrecipes.com/wp-content/uploads/2022/02/veg-noodles-vegetable-noodles-recipe.jpg",
        description: "Sumptuous delicious food baked in our canteen with curated ingredients",
        price: 40
    },
    {
        title: 'Manchurian',
        rating: 5,
        imgURL: "https://i.ytimg.com/vi/xkMbJCtaaqA/maxresdefault.jpg",
        description: "Sumptuous delicious food baked in our canteen with curated ingredients",
        price: 30
    },
    {
        title: 'Frankie',
        rating: 4,
        imgURL: "https://i.ytimg.com/vi/_AT1UphuZwE/maxresdefault.jpg",
        description: "Sumptuous delicious food baked in our canteen with curated ingredients",
        price: 50
    }
]
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">VNR</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Vallurupalli Nageswara Rao Vignana Jyothi Institute of Engineering and Technology is a private engineering college in Hyderabad, India recognized by All India Council for Technical Education and affiliated to the Jawaharlal Nehru Technological University, Hyderabad..</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/VNRVJ/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/vnrvjietofficial2019/?hl=en/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="http://www.vnrvjiet.ac.in/" target="_blank">VNR VJIET</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>91-040-23042761.</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>postbox@vnrvjiet.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Vignana Jyothi Nagar,Pragathi Nagar,
                ...
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">MD-09</a></div>
                </main>
            </section>
        `;
        })
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://http://www.vnrvjiet.ac.in/" target="_blank">VNR VJIET</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
